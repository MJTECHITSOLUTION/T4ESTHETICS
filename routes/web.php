...
use App\Http\Controllers\PreconsultationController;
...
// Public signed Pré-consultation form (no auth required)
Route::get('preconsultation/public/{customerId}', [PreconsultationController::class, 'publicForm'])
    ->name('preconsultation.public')
    ->middleware('signed');
        ...
        Route::group(['as' => 'backend.', 'middleware' => ['auth']], function () {
            ...
            Route::group(['prefix' => ''], function () {
                ...
                */
                ...
                // Pré-consultation API (AJAX from modal)
                // Note: names are relative to the outer 'backend.' group
                Route::get('customers/preconsultation/{customerId}', [PreconsultationController::class, 'show'])->name('customers.preconsultation.show');
                Route::post('customers/preconsultation', [PreconsultationController::class, 'store'])->name('customers.preconsultation.store');
                // Pré-consultation PDF
                Route::get('customers/preconsultation/{customerId}/pdf', [PreconsultationController::class, 'pdf'])->name('customers.preconsultation.pdf');
            });
