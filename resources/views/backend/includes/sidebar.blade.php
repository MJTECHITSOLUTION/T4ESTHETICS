...
<div class="sidebar-base pr-hide
    ...
    <div class="d-flex align-items-center justify-content-start">
        <div class="logo-main">
            ...
            <img class="logo-normal img-fluid" src="{{ asset('img/logo.png') }}" height="30" alt="{{ app_name() }}" style="height: 100px;">
            {{-- <img class="logo-normal dark-normal img-fluid" src="{{ asset('img/logo/logo0.png') }}" height="30" alt="{{ app_name() }}"> --}}
            <img class="logo-mini img-fluid" src="{{ asset('img/logo/logo0.png') }}" height="30" alt="{{ app_name() }}">
            <img class="logo-mini dark-mini img-fluid" src="{{ asset('img/logo/logo0.png') }}" height="30" alt="{{ app_name() }}">
            </a>
        </div>
