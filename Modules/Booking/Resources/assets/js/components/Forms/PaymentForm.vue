    ...
    <div v-if="!subtotal==0">
      <div v-if="!check_coupon " class="">
        <div class="d-flex align-items-center justify-content-between">
          <div class="row mt-4">
            <div class="col-md-8">
              <InputField class="col-md-12" type="text" :label="$t('Avoir un coupon de réduction')" placeholder="" v-model="data.coupon_code" :is-read-only="isCouponApplied"></InputField>
            </div>
            <div class="col-md-4">
              <button v-if="!isCouponApplied" type="button" class="btn btn-primary btn-apply mt-5" @click="couponValidate">Appliquer</button>
