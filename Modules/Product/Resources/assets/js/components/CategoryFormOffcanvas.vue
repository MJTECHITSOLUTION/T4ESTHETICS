...
const setFormData = (data) => {
  ...
  resetForm({
    values: {
      ...
      // Do not send existing URL back; only send when a new File is chosen
...
const formSubmit = handleSubmit((values) => {
  ...
  // Only include feature_image if it's a File (newly selected). Otherwise, omit to keep existing image
